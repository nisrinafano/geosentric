<body id="page-top">
    <div class="slideshow">
        ...
        <div class="mySlides">
           <img src="<?php echo base_url()."assets/img/";?>home3.jpg ?>" alt="Header" class="img-responsive" style="width:100%">
        </div>
        <div class="mySlides">
           <img src="<?php echo base_url()."assets/img/";?>home0.jpg ?>" alt="Header" class="img-responsive" style="width:100%">
        </div>
    </div>
    <section id="about" class="bg-second">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h2 class="section-heading">About</h2>
                    <hr class="light sr-icons">
                    <h3 class="text-faded">Geosentic adalah</h3>
                    <p class="text-faded">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                    </p>
                    <h3 class="text-faded">Sejarah Geosentic</h3>
                    <p class="text-faded">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                    </p>
                </div>
    ...
    <section id="jadwal" class="bg-second">
       <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
    ...
    <section id="informasi" class="bg-Primary">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
    ...
    <section id="contacts" class="bg-second">
                 <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
